...
const PostSection = () => {
  ...
  useEffect(() => {
    ...
    if (!localStorage.getItem("posts")) {
      axios
        .get(
          "https://academics.newtonschool.co/api/v1/facebook/post?limit=98",
          {
            headers: {
              projectId: "ym36gw00it6q",
            },
          },
        )
        .then((response) => {
  ...
  const handleComment = (event) => {
    ...
    if (event.key === "Enter") {
      ...
      axios
        .post(
          `https://academics.newtonschool.co/api/v1/facebook/comment/${commentPost._id}`,
          bodyContent,
          { headers: headersList },
        )
        .then((response) => {
          ...
          axios
            .get(
              `https://academics.newtonschool.co/api/v1/facebook/post/${commentPost._id}/comments`,
              { headers: headersList },
            )
            .then((response) => {
