...
const UserDetail = () => {
  ...
  return (
    <Box
      ...
      mt="7px"
      sx={{ "@media(max-width:650px)": { flexDirection: "column" }, marginTop:"80px" }}>
      <Box>
    ...
    <div className="Pro">
      ...
      <Box
        ...
        <Box display="flex">
          <Box mt="50px" ml="20px" width="50%">
            <Typography fontSize="23px" fontWeight="600" fontFamily="Helvetica">
              Akash
            </Typography>
            
            <Typography fontSize="18px" color="#949494" fontFamily="Helvetica">
              
              350 Followers  500 Connections
            </Typography>
           

          </Box>
          <Box mt="50px" ml="20px" alignItems="center" marginBottom="3px">
