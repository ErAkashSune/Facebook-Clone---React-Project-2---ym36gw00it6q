...
function SignIn() {
  ...
  const [email, setEmail] = useState("akashsune@gmail.com");
  const [password, setPassword] = useState("12345678");
  const navigate = useNavigate();

  const handleClickShowPassword = () => setShowPassword((show) => !show);
  const projectId = "ym36gw00it6q";
  ...
  return (
    <div style={{ display: "flex", flexDirection: "row" , justifyContent:"center" ,marginTop:"150px",gap:"30px"}}>
      ...
      <Box className="signUpBox">
        ...
        <Typography variant="h4" fontSize="17px" mb="10px">
          Stay updated on your Social world
        </Typography>
        <OutlinedInput
      ...
      <Typography variant="h4" textAlign="center" fontSize="17px" mt="20px">
        ...
        <Button
         onClick={() => navigate("/signup")}
          ...
          sx={{ borderRadius: "30px",background:"green", mt: "20px", height: "50px" ,Size:"100%"}}>
          Create Account
        </Button>
      </Typography>
      </Box>
